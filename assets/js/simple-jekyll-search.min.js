    ...
    var i={
        compile:function(r){
            ...
            var n=o.middleware(e,r[e],o.template);return void 0!==n?n:r[e]||t})
                ...
                searchResultTemplate:'<div class="card blog-post"><div class="card-body center"><a href="{url}" class="card-title" title="{desc}">{title}</a><p class="card-text">{summary}</p><a href="{url}" class="btn btn-outline-primary btn-sm">Read</a></div></div>',
